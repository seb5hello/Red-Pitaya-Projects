...
HD_PWD='D:/Xilinx/RedPitaya/prj/v0.94/Red-Pitaya-Projects/DAC_ACD_test_project/DAC_ACD_test_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAC_ADC_test_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAC_ADC_test_top.tcl
