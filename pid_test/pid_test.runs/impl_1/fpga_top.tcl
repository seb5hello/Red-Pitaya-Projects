...
namespace eval ::optrace {
  variable script "D:/Xilinx/RedPitaya/prj/v0.94/Red-Pitaya-Projects/pid_test/pid_test.runs/impl_1/fpga_top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/Xilinx/RedPitaya/prj/v0.94/Red-Pitaya-Projects/pid_test/pid_test.runs/synth_1/fpga_top.dcp
...
OPTRACE "Write Bitstream: post hook" START { }
  set src_rc [catch { 
    puts "source D:/Xilinx/RedPitaya/prj/v0.94/Red-Pitaya-Projects/pid_test/generate_bin.tcl"
    source D:/Xilinx/RedPitaya/prj/v0.94/Red-Pitaya-Projects/pid_test/generate_bin.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script D:/Xilinx/RedPitaya/prj/v0.94/Red-Pitaya-Projects/pid_test/generate_bin.tcl failed"
    return -code error
  }
