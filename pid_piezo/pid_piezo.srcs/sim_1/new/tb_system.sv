...
module tb_system;
    ...
    pid_top pid_top_inst (
        ...
        .sys_addr(sys4_addr), .sys_wdata(sys4_wdata), .sys_wen(sys4_wen), .sys_ren(sys4_ren), .sys_rdata(sys4_rdata), .sys_err(sys4_err), .sys_ack(sys4_ack)
    );
    ...
    task configure_system();
        ...
        write_bus(3, 20'h30, 32'd2);       // filter_mode
