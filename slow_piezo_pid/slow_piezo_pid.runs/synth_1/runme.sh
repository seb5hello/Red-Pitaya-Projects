...
HD_PWD='C:/Users/Gaming/Documents/fpga_projects/RedPitaya/prj/v0.94/Red Pitaya Projects/slow_piezo_pid/slow_piezo_pid.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log piezo_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source piezo_top.tcl
