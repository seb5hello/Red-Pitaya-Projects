////////////////////////////////////////////////////////////////////////////////
// WRAPPER MODULE: 4-Peak Timestamp & Serial Sampling Bus Interface (SYS[3])
////////////////////////////////////////////////////////////////////////////////
module custom_timestamp_detector (
    ...
    always_ff @(posedge clk_i) begin
        if (~rstn_i) begin
            ...
            // Read Path (Registered for stability)
            if (sys_ren) begin
                case (sys_addr[19:0])
                    20'h00000: sys_rdata <= {18'h0, threshold_reg};
                    20'h00004: sys_rdata <= {28'h0, peak_count_wire, done_wire}; 
                    20'h00008: sys_rdata <= ts_1_wire;
                    20'h0000C: sys_rdata <= ts_2_wire;
                    20'h00010: sys_rdata <= ts_3_wire;
                    20'h00014: sys_rdata <= ts_4_wire;
                    default:   sys_rdata <= 32'h0;
                endcase
            end else begin
                // Clear read bus when not actively requested
                sys_rdata <= 32'h0; 
            end
        end
    end
