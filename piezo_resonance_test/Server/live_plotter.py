...
DET_OFFSET_CYCLES = 0   # Preemptive window offset
FILTER_MODE = 2           # 0: Bypass, 1: Strict, 2: Smart Sweep
...
def configure_system():
    ...
    # Updated Configuration Dictionary for Filter
    det_cfg  = {
...
if __name__ == "__main__":
    try:
        # Initialize in safe disarmed Mode 0
        write_sys_ctrl(mode=0, trigger=0)
        configure_system()
        run_test()
        fetch_results() 
