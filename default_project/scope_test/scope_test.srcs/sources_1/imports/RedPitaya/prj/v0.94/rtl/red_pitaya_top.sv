...
logic [16-1:0] par_dat = '0; // Tied off as Daisy chain is removed
...
logic                 adc_clk;
logic                 adc_rstn;
logic                 adc_clk_daisy = 1'b0; // Tied off 
logic                 scope_trigo;
...
// Unused sys busses tied off
generate
for (genvar i=2; i<8; i++) begin: for_sys_stubs
...
////////////////////////////////////////////////////////////////////////////////
// DAC IO (Safely driven to zero to prevent floating outputs)
////////////////////////////////////////////////////////////////////////////////
...
// Safely tie off unused PWM & Daisy outputs
...
// trig_asg_out removed, map only to scope
assign trig_ext        = gpio.i[GDW]; 
assign trig_output_sel = scope_trigo;
...
rp_scope_com #(
  ...
  .trig_asg_i    (1'b0          ),  // ASG removed, tie to 0
